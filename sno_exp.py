...
for i in range(args.max_iter_safe_exp):
    ...
    states_p.append(next_sample[0])
    actions_p.append(next_sample[1])
...
# Load the data
data = np.load('result/safe_near_opt_mdp_es2.npz')
history_reward = data['history_reward']

# Plot the reward history
plt.figure(figsize=(12, 6))
plt.plot(history_reward[0:450], label='Reward History', color='blue')
plt.title('Reward History Over Time')
